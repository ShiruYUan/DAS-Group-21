...
For the further extension, we could check the GLMs' model assumtion , to see if the model really fits well. Also could use other method to detect all the models that seems to fit well from the formal analysis, which one will perform the best of the model.
