...
```{r boxplot, warning=FALSE, message=FALSE, fig.cap="\\label{box:Newprice} Boxplot of newprice by numeric varialbes", fig.width=5, fig.height=3}
#Boxplot
...
```{r barplot1, warning=FALSE, message=FALSE, fig.cap="\\label{bar1:Newprice}Boxplot of newprice by categorical varialbes(category)", fig.width=20, fig.height=10}
#Barplot
bar1<-ggplot()+ 
...
```{r barplot2, warning=FALSE, message=FALSE, fig.cap="\\label{bar2:Newprice}Boxplot of newprice by categorical varialbes(sellable_online)", fig.width=5, fig.height=2.5}
bar2<-ggplot()+ 
  geom_bar(data=group21_new,
...
```{r barplot3, warning=FALSE, message=FALSE, fig.cap="\\label{bar3:Newprice}Boxplot of newprice by categorical varialbes(other_colors)", fig.width=5, fig.height=2.5}
bar3<-ggplot()+ 
  geom_bar(data =group21_new,
