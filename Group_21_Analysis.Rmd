...
```
Figure \ref{box:Newprice}, shows three different variables (`depth`, `height`, `width`) in `newprice`. It can be t that there is more difference in Plot3 between `newprice` and `width`, meaning the `width` will influence the price more than other two variables.
