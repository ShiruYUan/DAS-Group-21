...
```{r export,warning=FALSE, message=FALSE, include=FALSE, eval=FALSE}
...
```{r colinearityNumeric, warning=FALSE, message=FALSE,fig.cap="\\label{cor:numerical}Correlation in numerical variables", fig.width=4, fig.height=4}
...
```{r boxplot, warning=FALSE, message=FALSE, fig.cap="\\label{box:Newprice} Boxplot of newprice by numeric variables", fig.width=5, fig.height=3}
#Boxplot
