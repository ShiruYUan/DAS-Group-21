...
# Formal analysis
```{r}
#Fit the GLM with all variables
model<- glm(newprice ~ category+sellable_online+other_colors+depth+height+width, data = group21_new,
               family = binomial(link = "logit"))

#Use stepwise selection to select best model
step_model <- step(model, direction = "both")

#Based on AIC pick the best fitted model
...
#Omit the variables by checking the p-value
