...
```{r boxplot, warning=FALSE, message=FALSE, fig.cap="\\label{box:Newprice} Boxplot of newprice by numeric vairalbes", fig.width=5, fig.height=3}
#Boxplot
...
```{r barplot1, warning=FALSE, message=FALSE, fig.cap="\\label{bar1:Newprice}Boxplot of newprice by categorical vairalbes(category)", fig.width=20, fig.height=10}
#Barplot
bar1<-ggplot()+ 
...
```{r barplot2, warning=FALSE, message=FALSE, fig.cap="\\label{bar2:Newprice}Boxplot of newprice by categorical vairalbes(sellable_online)", fig.width=5, fig.height=2.5}
bar2<-ggplot()+ 
  geom_bar(data=group21_new,
...
```{r barplot3, warning=FALSE, message=FALSE, fig.cap="\\label{bar3:Newprice}Boxplot of newprice by categorical vairalbes(other_colors)", fig.width=5, fig.height=2.5}
bar3<-ggplot()+ 
  geom_bar(data =group21_new,
