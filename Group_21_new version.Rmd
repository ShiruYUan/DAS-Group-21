...
```{r colinearityNumeric, warning=FALSE, message=FALSE,fig.cap="\\label{cor:numerical}Correlation in numerical variables", fig.width=5, fig.height=5}
...
#best model from model_5 (AIC=366.49)
model_6$call
#HLtest
...
#best model from model_7 (AIC=366.52)
model_8$call
#HLtest
...
#best model from model_9 (AIC=361.53)
model_10$call
#HLtest
...
#best model from model_11 (AIC=354.19)
model_12$call
#HLtest
